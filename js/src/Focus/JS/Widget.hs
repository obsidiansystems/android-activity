...
typeaheadSearch :: (MonadFocusWidget v app t m)
                => Text
...
typeaheadSearchDropdown :: (MonadFocusWidget v app t m, Ord k)
                        => Text
                        -- ^ text input placeholder
                        -> (Text -> ViewSelector app SelectedCount)
                        -- ^ setter for query field of view selector
...
typeaheadSearchMultiselect :: (MonadFocusWidget v app t m, Ord k)
                           => Text
                           -- ^ text input placeholder
                           -> (Text -> ViewSelector app SelectedCount)
                           -- ^ setter for query field of view selector
...
simpleCombobox :: forall app t m k v. (HasView app, MonadFocusWidget v app t m, Ord k)
