...
transitionWorkflow :: forall t m a. (DomBuilder t m, PerformEvent t m, PostBuild t m, TriggerEvent t m, MonadFix m, MonadHold t m, MonadJSM (Performable m)) => Transition -> Transition -> Workflow t m a -> Workflow t m a
