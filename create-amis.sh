...
# Adapted from https://github.com/NixOS/nixpkgs/blob/d0f2361bc1ffdff631fc7ebb9c2ec1b08b135898/nixos/maintainers/scripts/ec2/create-amis.sh
# Invoke like this:
# AWS_ACCESS_KEY_ID=AKI... AWS_SECRET_ACCESS_KEY=... NIX_PATH="nixpkgs=$(nix-instantiate --eval --strict ./reflex-platform -A nixpkgs.path | sed 's/"//g')" ./create-amis.sh
