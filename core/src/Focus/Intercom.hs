...
hashIntercom (IntercomSecretKey intercomSecretKey) email = IntercomUserHash $ T.pack $ showDigest $ hmacSha256 (LBS.fromStrict $ encodeUtf8 intercomSecretKey) $ LBS.fromStrict $ encodeUtf8 email
